...
CREATE TABLE `artistphonenumbers` (
  ...
  CONSTRAINT `artistPhoneNumbers_FK` FOREIGN KEY (`artistID`) REFERENCES `artist` (`artistID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `artistphonenumbers` VALUES (290337845,'544473285'),(467374211,'552238546'),(589035216,'555234232'),(602497126,'553455296'),(734228356,'222543780');
