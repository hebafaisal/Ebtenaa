...
CREATE TABLE `employeephonenumbers` (
  ...
  CONSTRAINT `employeePhoneNumbers_FK` FOREIGN KEY (`employeeID`) REFERENCES `employee` (`employeeID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `employeephonenumbers` VALUES (202343116,'552247546'),(202343677,'554725296'),(202344167,'222440780'),(202354763,'544463285'),(203214634,'555342232');
